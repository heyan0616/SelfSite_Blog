...
（本部分[原文地址](http://tutorials.jenkov.com/java-nio/nio-vs-io.html)，作者：Jakob Jenkov)
...
使用纯粹的NIO设计相较IO设计，数据处理也受到影响。 <br>在IO设计中，我们从InputStream或 Reader逐字节读取数据。假设你正在处理一基于行的文本数据流，例如：
...
<div style="display:flex;"><img src="./images/niovsio-1.jpg" alt="从一个阻塞的流中读数据" style="zoom:80%;display:block;" align="left"/></div>
